...
public class At04 {
	...
	public static void main(String[] args) {
		...
		while (continuar.equalsIgnoreCase("s")) {
			...
			System.out.println("2- Homem Cis digite");
			System.out.println("3- Não Binário digite");
			System.out.println("4- Mulher Trans digite");
			System.out.println("5- Homem Trans digite");
			System.out.println("6- Outros digite");
			identidadeGenero = leia.nextInt();
			System.out.println(" Pessoa Desenvolvedora");
			System.out.println("1- Backend digite");
			System.out.println("2- Frontend digite");
			System.out.println("3- Mobile digite");
			System.out.println("4- FullStack digite");
